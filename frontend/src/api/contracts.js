...
export const tenderPeriodOverlapHintApi = (params) =>
  http.get('/contracts/tender/period-overlap-hint', { params })
...
export const tenderAwardContextApi = (tenderId) => http.get(`/contracts/tender/${tenderId}/award-context`)
