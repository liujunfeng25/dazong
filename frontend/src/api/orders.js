...
export const listReceivingDifferencesApi = (params) => http.get('/orders/receiving/differences', { params })
export const reviewOrderReturnApi = (returnId, payload) => http.post(`/orders/returns/${returnId}/review`, payload)
export const orderDetailApi = (id) => http.get(`/orders/${id}`)
export const orderLogisticsTrackingApi = (id) => http.get(`/orders/${id}/logistics-tracking`)
...
export const printAllocationLabelsApi = (orderId, allocationIds) =>
  http.post(`/orders/${orderId}/print-allocation-labels`, { allocation_ids: allocationIds })
